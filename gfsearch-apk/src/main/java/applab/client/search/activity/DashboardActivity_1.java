 ...
 */
public class DashboardActivity_1 extends BaseActivity {
...
//        tv.setText(helper.farmerCountByCommunityGroup().size() + " Communities");
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(DashboardActivity_1.this, FarmerActivity.class);
...
//        tableRow_farmers = (TableRow) findViewById(R.id.tableRow_farmers);
        ...
        DashboardMenuAdapter adapter = new DashboardMenuAdapter(DashboardActivity_1.this, images, titles);
        ...
        clients.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(DashboardActivity_1.this, ClientActivity.class);
                startActivity(intent);
            }
        });
        ...
        meetings.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(DashboardActivity_1.this, ScheduledMeetingsActivity.class);
                startActivity(intent);
            }
        });
        ...
        suppliers.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(DashboardActivity_1.this, SupplierActivity.class);
                startActivity(intent);
            }
        });
        ...
        markets.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
               Intent intent = new Intent(DashboardActivity_1.this, MarketActivity.class);
                startActivity(intent);
            }
        });
        ...
        technical.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(DashboardActivity_1.this, MainActivity.class);
                startActivity(intent);
            }
        });
...
//        });
        ...
        grid_menu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i) {
                    case 0:
                        intent = new Intent(DashboardActivity_1.this, ClientActivity.class);
                        startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(DashboardActivity_1.this, ScheduledMeetingsActivity.class);
                        startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(DashboardActivity_1.this, SupplierActivity.class);
                        startActivity(intent);
                        break;
                    case 3:
                        intent = new Intent(DashboardActivity_1.this, MarketActivity.class);
                        startActivity(intent);
                        break;
                    case 4:
                        intent = new Intent(DashboardActivity_1.this, MainActivity.class);
                        startActivity(intent);
                        break;
                }
            }
...
//            }
                ...
                Intent intent = new Intent().setClass(this, DashboardActivity_1.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_TASK_ON_HOME);
                this.startActivity(intent);
