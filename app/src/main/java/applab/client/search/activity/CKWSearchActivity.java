...
import applab.client.search.ui.fragment.DefaultViewFragment;
import applab.client.search.ui.fragment.FavouriteViewFragment;
import applab.client.search.ui.fragment.RecentSearchesViewFragment;
...
public class CKWSearchActivity extends Activity implements ActionMode.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        try {
            ...
            Log.e(CKWSearchActivity.class.getName(), "Application Error", ex);
        }
    }
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        AlertDialog alertDialog =
                                new AlertDialog.Builder(CKWSearchActivity.this).create();
