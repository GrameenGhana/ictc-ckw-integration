    ...
    private Drawable getSearchLogImageViewDrawable(SearchLog param) {
        ...
        if (searchMenuItem != null) {
            if (isSearchLogSelected(param)) {
                return context.getResources().getDrawable(R.mipmap.ic_action_accept);
            }
        ...
        if (searchLog != null) {
            if (!isSearchLogSelected(searchLog)) {
                ...
                if (imageView != null) {
                    ...
                    imageView.setImageDrawable(context.getResources().getDrawable(R.mipmap.ic_action_accept));
                }
            }
        }
    }
