...
//            save();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (menuItem != null) {
            ...
            if (record != null) {
                menuItem.setIcon(R.mipmap.rating_important);
            } else {
                menuItem.setIcon(R.mipmap.rating_not_important);
            }
        }
    ...
    private void markContentFavourite(MenuItem item) {
        ...
        if (record == null) {
            ...
            item.setIcon(R.mipmap.rating_important);
        } else {
            menuItemService.delete(record);
            item.setIcon(R.mipmap.rating_not_important);
        }
    }
    ...
    private void sendContentAsMessage() {
        ...
        sharingIntent.putExtra(Intent.EXTRA_SUBJECT, searchMenuItem.getLabel());
