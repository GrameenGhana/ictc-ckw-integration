...
**/
    ...
    public static List<MeetingActivity> getMeetingActivity(int meetingIndex){
        ...
        if(1==meetingIndex){
            ...
            activities.add(new MeetingActivity("Sensitize farmers","I","A",1,"content not available"));
            activities.add(new MeetingActivity("Explain Value Proposition", "I", "A",2,"content not available"));

            activities.add(new MeetingActivity("Explain Processes and Commitment","I","A",4,"content not available"));
            //activities.add(new applab.client.search.model.MeetingActivity("Explain value proposition","I","A",5, replaceRadioTVSchedule()));
        }else if(2==meetingIndex){
            activities.add(new MeetingActivity("Enroll and Profile Farmers","I","A",1,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Previous Performance(Producton)", "I", "T",2,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Previous Performance(Producton)", "I", "T",2,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Previous Performance(Farm Credit)", "I", "T",2,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Provide Input Package", "I", "A",4,""));
            activities.add(new MeetingActivity("Activities for Next Visit", "I", "A",4,""));
            activities.add(new MeetingActivity("Provide Technical Assistance", "I", "C",3,""));
            activities.add(new MeetingActivity("Provide Key Learning Needs", "I", "C",3,""));
            activities.add(new MeetingActivity("Share Radio and TV Schedules", "I", "A",4,LAUNCH_TAROWORKS));
           ...
           // activities.add(new applab.client.search.model.MeetingActivity("Baseline Data Collection", "I", "T",2,LAUNCH_TAROWORKS+" Farmer Baseline Data"));
            ...
            activities.add(new MeetingActivity("Farm Plan(Production)","T","A",1,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Farm Plan(Post-harvest)","T","A",2,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Previous Performance(Farm Credit)", "I", "T",2,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Provide Input Package", "I", "A",4,""));
            activities.add(new MeetingActivity("Activities for Next Visit", "I", "A",4,""));
            activities.add(new MeetingActivity("Provide Technical Assistance", "I", "C",3,""));
            ...
            activities.add(new MeetingActivity("Share  Radio and TV schedules with farmer","I","A",5, replaceRadioTVSchedule()));
            //activities.add(new applab.client.search.model.MeetingActivity("Requests from farmers","I","T",6,LAUNCH_TAROWORKS+"\n"));

        }else if(4==meetingIndex){

            activities.add(new MeetingActivity(COLLECT_FARM_MEIASUREMENT,"I","A",1,"Measurement of Farm"));
            activities.add(new MeetingActivity(DELIVER_INPUTS, "I", "A",2,DELIVER_INPUTS));
            activities.add(new MeetingActivity("Confirm delivery of inputs","I","A",3,""));
            activities.add(new MeetingActivity("Update Farm Plan(After Planting)","I","T",4,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Activities for Next Visit","I","A",5,FARMER_PROFILE));
            activities.add(new MeetingActivity("Provide Technical Assistance","I","C",6,LAUNCH_CKW));
            activities.add(new MeetingActivity("Provide Key Learning Needs","I","A",7,"to"));
            activities.add(new MeetingActivity("Share Radio and TV schedules","I","A",8, replaceRadioTVSchedule()));

        }else if(5==meetingIndex){


            activities.add(new MeetingActivity("Crop Assessment","T","A",1,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Activities for Next Visit","I","A",6,""));
            activities.add(new MeetingActivity("Provide Technical Assistance", "I", "C",2,LAUNCH_CKW));
            activities.add(new MeetingActivity("Provide Key Learning Needs","I","A",7,"to"));
            activities.add(new MeetingActivity("Share Radio and TV schedules","I","A",3,replaceRadioTVSchedule()));
        }else if(6==meetingIndex){

            activities.add(new MeetingActivity("Update Farm Plan(After harvest)","I","A",1,FARMER_PROFILE));
            activities.add(new MeetingActivity("Activities for Next Visit", "I", "A",2,"DISCCUSSION"));
           // activities.add(new applab.client.search.model.MeetingActivity("Provide farmer with upcoming activities on farm plan","I","A",3,FARMER_PROFILE));
            activities.add(new MeetingActivity("Provide Technical Assistance","I","A",4,LAUNCH_CKW));
            activities.add(new MeetingActivity("Provide Key Learning Needs","I","A",7,"to"));
            activities.add(new MeetingActivity("Share TV Schedule","I","A",3,"Collect Farmer Feedback"));
           // activities.add(new applab.client.search.model.MeetingActivity("Collect request for assistance","I","A",4,"Collect Agent Feedback"));
            ...
            activities.add(new MeetingActivity("Update Farm Plan(Post-harvest)","G","T",1,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Update Farm Plan(After Selling)","G","T",1,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Update Farm Plan(Farm Credit)","G","T",1,LAUNCH_TAROWORKS));
            activities.add(new MeetingActivity("Reconcile Credit and Repayments","G","C",6,LAUNCH_CKW));
            activities.add(new MeetingActivity("Provide Farmers with Overall Results", "G", "C",2,FARMER_PROFILE));
            activities.add(new MeetingActivity("Collect Farmer Feedback","G","T",3,LAUNCH_TAROWORKS));
           // activities.add(new applab.client.search.model.MeetingActivity("Collect agent feedback", "G", "T",2,LAUNCH_TAROWORKS));
            ...
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Initial","G","A",1,ATTENDANCE));
            activities.add(new MeetingActivity("Provide input package", "G", "A",2,SHARE_INPUT_PACKAGE));
            activities.add(new MeetingActivity("Radio program on seed","G","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Video on selecting varieties, use of good quality seed, land preparation, planting","G","C",4,LAUNCH_CKW));
            activities.add(new MeetingActivity("Provide input package","G","A",3,SHARE_INPUT_PACKAGE));
            activities.add(new MeetingActivity("Confirm delivery of input credit package","G","A",4,"Confirm Delivery"));
            activities.add(new MeetingActivity("PLAY THE GAME","G","A",3,"Play a Game",false));
            activities.add(new MeetingActivity("Collect feedback on session","G","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Final","G","A",4,ATTENDANCE));
        }
            ...
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Initial","G","A",1,ATTENDANCE));
            activities.add(new MeetingActivity("Provide input package", "I", "A",2,"Collect Payments"));
            activities.add(new MeetingActivity("Radio program on fertilizer","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Video on fertilizer application","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity("Provide input package","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Confirm delivery of input credit package","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity("PLAY THE GAME","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Collect feedback on session","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Final","-","A",4,ATTENDANCE));
            ...
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Initial","G","A",1,ATTENDANCE));
            activities.add(new MeetingActivity("Radio program on fertilizer","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Video on fertilizer application and soil fertility maintenance","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity("Confirm delivery of input credit package","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity("PLAY THE GAME","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Collect feedback on session","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Final","-","A",4,ATTENDANCE));
            ...
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Initial","G","A",1,ATTENDANCE));
            activities.add(new MeetingActivity("Discuss Food Security","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Video on harvest and post harvest","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Confirm delivery of input credit package","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity("PLAY THE GAME","I","A",3,"Collect Farmer Feedback"));
            activities.add(new MeetingActivity("Collect feedback on session","-","A",4,"Collect Agent Feedback"));
            activities.add(new MeetingActivity(TAKE_ATTENDANCE+" Final","-","A",4,ATTENDANCE));
...
*/
    public static String  [] getGroupMeetingTitles(boolean withFirst){
...
//                "4th Group Meeting"};
    ...
    public static String  [] getIndividualMeetingTitles(boolean withFirst){
