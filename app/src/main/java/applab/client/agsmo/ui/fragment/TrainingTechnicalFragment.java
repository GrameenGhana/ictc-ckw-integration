...
public class TrainingTechnicalFragment extends Fragment implements View.OnClickListener {
    ...
    public static TrainingTechnicalFragment newInstance(int position, String u) {
		TrainingTechnicalFragment f = new TrainingTechnicalFragment();
		Bundle b = new Bundle();
